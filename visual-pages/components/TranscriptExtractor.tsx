    ...
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="card p-8 mb-8">
        ...
        <div className="space-y-6">
          {/* URL Input */}
          <div>
            <label htmlFor="youtube-url" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
              YouTube URL
            </label>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <label className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                  ...
                  />
                  <div>
                    <div className="font-medium text-gray-900 dark:text-gray-100">TXT</div>
                ...
                <label className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                  ...
                  />
                  <div>
                    <div className="font-medium text-gray-900 dark:text-gray-100">SRT</div>
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-3">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Premium Formats</span>
                  {!isPremium && (
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <label htmlFor="ai-summary" className="text-sm font-semibold text-gray-700 dark:text-gray-300">
              ...
              {includeSummary && (
                <div className="ml-7 space-y-2 animate-fade-in">
                  <label htmlFor="summary-type" className="block text-xs font-medium text-gray-600 dark:text-gray-400">
                    Summary Type
                  </label>
                  <select
                    id="summary-type"
        ...
        <div className="card p-8 animate-slide-up">
          ...
          {result.metadata && (
            <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">Video Information</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                {result.metadata.title && (
                  <div>
                    <span className="font-medium text-gray-600 dark:text-gray-400">Title:</span>
                    <p className="mt-1 text-gray-900 dark:text-gray-100">{result.metadata.title}</p>
                  </div>
                )}
                {result.metadata.channel && (
                  <div>
                    <span className="font-medium text-gray-600 dark:text-gray-400">Channel:</span>
                    <p className="mt-1 text-gray-900 dark:text-gray-100">{result.metadata.channel}</p>
                  </div>
                )}
                <div>
                  <span className="font-medium text-gray-600 dark:text-gray-400">Word Count:</span>
                  <p className="mt-1 text-gray-900 dark:text-gray-100">{getWordCount().toLocaleString()} words</p>
                </div>
                <div>
                  <span className="font-medium text-gray-600 dark:text-gray-400">Language:</span>
                  <p className="mt-1 text-gray-900 dark:text-gray-100">{(result.metadata.language || selectedLanguage).toUpperCase()}</p>
                </div>
                <div>
                ...
                <div>
                  <span className="font-medium text-gray-600 dark:text-gray-400">Segments:</span>
                  <p className="mt-1 text-gray-900 dark:text-gray-100">{result.metadata.segment_count || 0}</p>
                </div>
              </div>
            </div>
          )}
          ...
          {result.ai_summary && (
            <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">AI-Generated Summary</h3>
                <span className="text-xs bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-200 px-2 py-1 rounded-full">
          ...
          {/* Download Actions */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Download Options</h3>
            
            {/* Free Format Downloads */}
            <div className="mb-4">
              <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Free Formats</h4>
          ...
          <details className="group">
            <summary className="cursor-pointer text-lg font-semibold text-gray-900 dark:text-gray-100 hover:text-electric-600 dark:hover:text-electric-400 transition-colors py-2 flex items-center gap-2">
      ...
      {/* Pro Features Teaser */}
      <div className="card-hover p-6 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-purple-200 dark:border-purple-800">
