          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <div className="font-semibold text-gray-900 dark:text-gray-100">{user?.name || 'Demo User'}</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">{user?.email || 'demo@example.com'}</div>
              </div>
              <button
