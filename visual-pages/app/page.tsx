        ...
        <div className="container-main relative">
          <div className="text-center max-w-4xl mx-auto animate-fade-in">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              <strong className="text-gray-900 dark:text-gray-100"> Free forever</strong> for single videos.
            </p>
      ...
      <section id="features" className="section bg-white dark:bg-gray-950">
        <div className="container-main">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <div className="lg:col-span-2 card-hover p-8 bg-gradient-to-br from-electric-50 to-blue-50 dark:from-electric-900/20 dark:to-blue-900/20 border-electric-200 dark:border-electric-800">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4 text-sm text-electric-600 dark:text-electric-400">
            ...
            {/* AI Summaries */}
            <div className="card-hover p-6 bg-gradient-to-br from-neon-purple/10 to-pink-100 dark:from-neon-purple/20 dark:to-pink-900/20">
            ...
            <div className="lg:col-span-2 card-hover p-6 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-orange-600 dark:text-orange-400 font-semibold">PRO FEATURE</div>
                </div>
              </div>
            </div>

            {/* Cloud Storage */}
            <div className="card-hover p-6 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20">
              ...
              <div className="text-xs text-purple-600 dark:text-purple-400 font-semibold">PRO FEATURE</div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="card p-8 relative">
              <div className="mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 mt-2">Perfect for individual creators</p>
              </div>
              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <span className="text-gray-900 dark:text-gray-100 font-medium">Unlimited single video extraction</span>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Process as many individual videos as you want</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-gray-900 dark:text-gray-100 font-medium">TXT & Markdown export</span>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Download transcripts in basic formats</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-gray-900 dark:text-gray-100 font-medium">No registration required</span>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Start using immediately</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full border-2 border-gray-300 dark:border-gray-600 mt-0.5 flex-shrink-0"></div>
                  <div>
                    <span className="text-gray-500 dark:text-gray-400">Channel & playlist processing</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full border-2 border-gray-300 dark:border-gray-600 mt-0.5 flex-shrink-0"></div>
                  <div>
                    <span className="text-gray-500 dark:text-gray-400">AI summaries</span>
                  </div>
                </li>
              </ul>
            ...
            <div className="relative">
              ...
              <div className="card p-8 bg-gradient-to-br from-electric-50 to-purple-50 dark:from-electric-900/20 dark:to-purple-900/20 border-electric-200 dark:border-electric-700 electric-glow">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">For serious content creators</p>
                </div>
                ...
                <ul className="space-y-4 mb-8">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="text-gray-900 dark:text-gray-100 font-medium">Everything in Free</span>
                      <p className="text-sm text-gray-500 dark:text-gray-400">All free features included</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-electric-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <span className="text-gray-900 dark:text-gray-100 font-medium">Unlimited channel & playlist processing</span>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Batch process entire channels</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-electric-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <span className="text-gray-900 dark:text-gray-100 font-medium">AI-powered summaries (GPT-4)</span>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Get intelligent video summaries</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-electric-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <span className="text-gray-900 dark:text-gray-100 font-medium">PDF, Word, Excel exports</span>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Professional format exports</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-electric-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <span className="text-gray-900 dark:text-gray-100 font-medium">90-day cloud storage</span>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Access your transcripts anywhere</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-electric-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <span className="text-gray-900 dark:text-gray-100 font-medium">Priority processing</span>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Skip the queue</p>
                    </div>
                  </li>
                </ul>
